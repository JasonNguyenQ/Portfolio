    ...
    return (
        <section id="education" ref={ref}>
            ...
            <div className="description">
                ...
                <ul>
                    <li>Attended <strong>University of California, Riverside</strong> in September of 2021 and graduated 3 years later in December of 2024 with a Bachelor's of Science in Computer Science</li>
